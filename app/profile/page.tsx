...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050814] text-white pb-32 relative overflow-hidden">
      ...
      {/* Navigation Footer */}
      <div className="fixed bottom-28 left-0 right-0 p-4 bg-gradient-to-t from-[#050814] via-[#050814]/90 to-transparent z-30 pb-safe">
        <div className="flex justify-center max-w-md mx-auto">
          <Link href="/" className="bg-gray-900 border border-gray-800 text-gray-400 hover:text-white px-6 py-3 rounded-full font-bold text-sm flex items-center gap-2 transition-colors shadow-lg">
